...
"""
openedx-filter-demos documentation build configuration file.
...
project = 'openedx-filter-demos'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'openedx-filter-demos'
...
#
# html_title = 'openedx-filter-demos v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'A Open edX plugin application for demoing some openedx-filters.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_filter_demos'),
                os.path.join(root_path, 'openedx_filter_demos/migrations')])
